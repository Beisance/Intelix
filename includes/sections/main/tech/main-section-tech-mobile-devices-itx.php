		...
		<div id="main-section-stack-1-content">
			...
			<div id="main-section-content">
				...
				if (!empty($sticky)) {
				  ...
				  $qry = new WP_Query(array('post__in' => $sticky, 'cat' => 15));
				  if ($qry->have_posts()) :
				...
				<?php
					...
					query_posts( array( 'post__not_in' => get_option('sticky_posts'), 'cat' => 15, 'posts_per_page' => 5, 'paged' => get_query_var('paged') ) );
	...
	<div id="main-section-stack-5">
		<div id="main-section-stack-5-content">
			...
			<div id="main-section-content">
				...
				<?php
					// Filtering for non-sticky posts.
					query_posts( array( 'post__not_in' => get_option('sticky_posts'), 'cat' => 15, 'posts_per_page' => 10, 'paged' => get_query_var('paged') ) );
					// Run the loop to output the non-sticky posts.
					get_template_part( 'loop-news-stack', 'index' );
				?>
			</div>
